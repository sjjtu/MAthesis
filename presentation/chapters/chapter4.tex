...
\begin{frame}{AE-(dp)MERF: Utility}
    \begin{figure}
        \centering
        \includegraphics[scale=0.3]{results_aedpmerf_acc.png}
...
\begin{frame}{AE-(dp)WGAN: Utility}
    \begin{figure}
        \centering
        \includegraphics[scale=0.3]{restuls_dprtsgan_acc.png}
...
\begin{frame}{Contamination}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[scale=0.23]{str_comtam.png}
    ...
    \begin{columns}
        \begin{column}{0.65\textwidth}
            \begin{figure}
                ...
                \centering
                \only<1>{\includegraphics[width=0.7\textheight]{results_aedpmerf_contam_acc.png}}%
                \only<2>{\includegraphics[width=0.7\textheight]{results_aedpmerf_contam_baseline_acc.png}}%
                \only<3>{\includegraphics[width=0.7\textheight]{results_aedpmerf_contam_aemerf_acc.png}}%
                \only<4>{\includegraphics[width=0.7\textheight]{results_aedpmerf_contam_aedpmerf_acc.png}}%
                \only<5>{\includegraphics[width=0.7\textheight]{results_aedpmerf_contam_acc.png}}
