...
loc="mitbih"
seq_len = 180
df = pd.read_csv('{}'.format(data_path), sep = ",")
...
parser.add_argument("--epochs", default=1, dest="epochs", type=int,
                    help="Number of full passes through training set for autoencoder")
parser.add_argument("--iterations", default=1, dest="iterations", type=int,
